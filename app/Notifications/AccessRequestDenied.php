...
class AccessRequestDenied extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->line("Your access request for the document '{$documentTitle}' has been denied by {$approverName}.")
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => "Your access request for the document '{$this->accessRequest->document->title}' has been denied by {$this->accessRequest->approver->name}.",
